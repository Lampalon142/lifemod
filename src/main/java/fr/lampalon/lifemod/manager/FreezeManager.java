...
public class FreezeManager {
    ...
    private void openFreezeGUI(Player player) {
        ...
        meta.setDisplayName(MessageUtil.parseColors(LifeMod.getInstance().getConfigConfig().getString("freeze-gui-glass-title")));
        item.setItemMeta(meta);

        Inventory freezeMenu = Bukkit.createInventory(null, 27, MessageUtil.parseColors(LifeMod.getInstance().getConfig().getString("freeze-gui-title")));
